...
- **token_monitor:** `~/.anthropic_usage.json` sem novas calls desde 2026-06-14 apesar da reconstrução de 2026-07-27 — investigar porque parou de novo (achado durante o teste do `VaultTokenSummary`)
