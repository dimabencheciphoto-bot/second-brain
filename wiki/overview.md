...
→ [[Overnight Engine]] · [[AI Patterns]] · [[MoviePy v2 Patterns]]
...
→ [[UGC Agency Launch]] · [[UGC Cold Outreach]] · [[UGC Pricing]]
...
2. `wiki/index.md` — catálogo de concepts, research, sources, sessions
3. PARA (`01-04/`) — estado de execução dos projectos e áreas
